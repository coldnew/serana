//! Prompt builder for Hermes-style agent.
//!
//! Assembles system prompt from:
//! - Personality (SOUL.md)
//! - Memory (MEMORY.md, USER.md)
//! - Skills and tools
//! - Context files (AGENTS.md, .serana.md)
...
impl PromptBuilder {
    /// Create a new prompt builder for the given workspace.
...
- Acknowledge when you don't know something"#,
    ...
    fn build_context_files_section(&self) -> String {
        ...
        // Check for .hermes.md (for compatibility)
