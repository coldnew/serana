...
pub fn render_status_line(editor: &MoraEditor, width: usize) -> Line<'static> {
    ...
    let (mode_label, mode_style) = match mode {
        EditorMode::Normal => (" NORMAL ", Style::new().fg(Color::Rgb(15, 18, 22)).bg(Color::Rgb(0, 180, 255)).add_modifier(Modifier::BOLD)),
        EditorMode::Insert => (" INSERT ", Style::new().fg(Color::Rgb(15, 18, 22)).bg(Color::Rgb(0, 255, 136)).add_modifier(Modifier::BOLD)),
        EditorMode::Command | EditorMode::SearchForward | EditorMode::SearchBackward => {
            (" CMD ", Style::new().fg(Color::Rgb(15, 18, 22)).bg(Color::Rgb(212, 192, 144)).add_modifier(Modifier::BOLD))
        }
        EditorMode::Emacs => (" EMACS ", Style::new().fg(Color::Rgb(15, 18, 22)).bg(Color::Rgb(255, 179, 71)).add_modifier(Modifier::BOLD)),
        EditorMode::ReplaceChar => (" REPLACE ", Style::new().fg(Color::Rgb(15, 18, 22)).bg(Color::Rgb(255, 71, 87)).add_modifier(Modifier::BOLD)),
        EditorMode::Visual => (" VISUAL ", Style::new().fg(Color::Rgb(15, 18, 22)).bg(Color::Rgb(180, 130, 20)).add_modifier(Modifier::BOLD)),
    };
    ...
    let bright = Style::new().fg(Color::Rgb(232, 236, 244)).add_modifier(Modifier::BOLD);
    let modified_style = Style::new().fg(Color::Rgb(255, 179, 71)).add_modifier(Modifier::BOLD);
...
pub fn render_command_line(editor: &MoraEditor, width: usize) -> Line<'static> {
    ...
    let prompt_style = Style::new().fg(Color::Rgb(0, 180, 255)).add_modifier(Modifier::BOLD);
...
pub fn render_help_bar(mode: EditorMode, width: usize) -> Line<'static> {
    let hints = match mode {
        EditorMode::Normal => "i:Insert  /:Search  ::Cmd  v:Visual  Ctrl-S:Save  Ctrl-Q:Quit  u:Undo",
        EditorMode::Insert => "Esc:Normal  Ctrl-S:Save  Arrows:Move",
        EditorMode::Command => "Enter:Exec  Esc:Cancel",
        EditorMode::SearchForward | EditorMode::SearchBackward => "Enter:Search  Esc:Cancel  n:Next  N:Prev",
        EditorMode::Emacs => "Ctrl-G:Normal  Ctrl-S:Search  Ctrl-X Ctrl-S:Save  Ctrl-X Ctrl-C:Quit",
        EditorMode::ReplaceChar => "Press char to replace with  Esc:Cancel",
        EditorMode::Visual => "hjkl:Select  d:Delete  y:Yank  Esc:Cancel",
    };
