...
use display_protocol::{
    Align, Border, BoxNode, FlexNode, Justify, OverlayNode, Padding, Style, UiNode,
};
...
impl Dialog {
    ...
    pub fn body(mut self, children: Vec<UiNode>) -> Self {
        self.body = children;
        self
    }
    ...
    pub fn actions(mut self, nodes: Vec<UiNode>) -> Self {
        self.actions = nodes;
        self
    }
    ...
    pub fn build(self) -> UiNode {
        let content = UiNode::Box(BoxNode {
            children: vec![UiNode::Column(FlexNode {
                children: vec![
                    UiNode::Row(FlexNode {
                        children: vec![UiNode::text(&self.title).bold().color(palette::LIGHT)],
                        style: Style::default(),
                        gap: 0,
                        align: Align::Center,
