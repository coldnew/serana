...
fn extract_keywords(instruction: &str) -> Vec<String> {
    let stop_words: &[&str] = &[
        ...
        "what", "which", "who", "whom", "why", "not", "no", "nor", "so",
        "for", "of", "to", "from", "by", "with", "in", "on", "at", "up",
        "out", "off", "over", "under", "about", "into", "through", "during",
        "before", "after", "above", "below", "between", "each", "few",
        "more", "most", "other", "some", "such", "than", "too", "very",
        "just", "also", "now", "here", "there", "all", "any", "both",
        "every", "only", "own", "same", "let", "make", "like", "get",
        "go", "see", "know", "take", "come", "think", "look", "want",
        "give", "use", "find", "tell", "ask", "work", "seem", "feel",
        "try", "leave", "call", "please", "help", "want", "need",
        "file", "code", "function", "implement", "fix", "change", "update",
        "add", "remove", "create", "write", "read", "run", "test",
    ];
